        ...
        <div class="container mt-3">
            <form method="GET" class="d-flex mb-2" role="search">
                <input class="form-control shadow-sm py-2" type="search" name="search" value="{{ Request::get('search') }}"
                    placeholder="Search blood donor..." aria-label="Search">
            </form>
        </div>
    </section>
                        ...
                        @foreach ($bloodDonors as $donor)
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card doctor-card mt-3">
                                    <img src="{{ Storage::url('profile/' . $donor->image) }}" class="rounded-1 p-3 pb-0"
                                        alt="Doctor image">
                                    <div class="card-body p-3">
                                        <span class="doctor-specialization">{{ $donor->city->name }}</span>
