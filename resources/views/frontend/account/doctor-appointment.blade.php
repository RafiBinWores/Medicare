                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center p-3 border rounded shadow-sm">
                                        <div class="doctor-image">
                                            <img src="{{ Storage::url('profile/' . $upcomingAppointment->user->image) }}"
                                                alt="user demo image"
                                        ...
                                        <div class="ps-3 d-flex justify-content-between w-100">
                                            <div>
                                                ...
                                                <p class="mb-1 fw-medium" style="font-size: 14px;">
                                                    <i class="fa-regular fa-envelope pe-1"
                                                        style="color: #023154;"></i>{{ $upcomingAppointment->email }}
                                                </p>
                                                <p class="mb-1 text-secondary fw-medium" style="font-size: 14px;">
                                                    <i class="fa-regular fa-phone pe-1"
                                                        style="color: #023154;"></i>{{ $upcomingAppointment->phone }}
                                                </p>
                                                <p class="mb-1 fw-medium" style="font-size: 14px;">
                        ...
                        <div class="row g-4">
                            @foreach ($expiredAppointments as $expiredAppointment)
                                <div class="col-12">
                                    <div class="d-flex align-items-center p-3 border rounded shadow-sm">
                                        <div class="doctor-image">
                                            <img src="{{ Storage::url('profile/' . $expiredAppointment->user->image) }}"
                                                alt="user demo image"
                                                style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover;">
                                        </div>
                                        <div class="ps-3 d-flex justify-content-between w-100">
                                            <div>
                                                <p class="fw-bold" style="color: #023154; margin-bottom: 12px;">
                                                    {{ $expiredAppointment->name }}
                                                </p>
                                                <p class="mb-1 fw-medium" style="font-size: 14px;">
                                                    <i class="fa-regular fa-envelope pe-1"
                                                        style="color: #023154;"></i>{{ $expiredAppointment->email }}
                                                </p>
                                                <p class="mb-1 text-secondary fw-medium" style="font-size: 14px;">
                                                    <i class="fa-regular fa-phone pe-1"
                                                        style="color: #023154;"></i>{{ $expiredAppointment->phone }}
                                                </p>
                                                <p class="mb-1 fw-medium" style="font-size: 14px;">
                                                    <i class="fa-regular fa-calendar-check pe-1"
                                                        style="color: #023154;"></i>Appointment On:
